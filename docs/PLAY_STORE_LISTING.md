...
## Screenshots needed (minimum 2, recommend 4–8)
...
4. Driver's open-requests feed
5. Active trip with live map + ETA
6. Rider Wallet screen (shows the change-credit balance concept clearly)
7. Driver subscription screen (shows the numbered "3 ways to pay" flow)
8. Admin dashboard overview (optional, shows platform depth)
